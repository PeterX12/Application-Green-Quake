/*! \mainpage The EfficientThermostat View Class
...
namespace Application_Green_Quake.Views.EcoActions.Energy
{
    ...
    public partial class EfficientThermostat : ContentPage
    {
        public EfficientThermostat()
        {
            InitializeComponent();
            OnAppearing();
        }
        ...
        */
        private async void AddPointsClicked(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                helper2.EfficientThermostatPoints();
