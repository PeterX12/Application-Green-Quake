/*! \mainpage The EcoFreidnlyApplicance View Class
...
namespace Application_Green_Quake.Views.EcoActions.Shopping
{
    ...
    public partial class EcoFreidnlyApplicance : ContentPage
    {
        public EcoFreidnlyApplicance()
        {
            InitializeComponent();
            OnAppearing();
        }
        ...
        */
        private async void AddPointsClicked(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                helper2.AppliancePoints();
                await DisplayAlert("Points Added", AppConstants.fourPointsMsg, "OK");
                await Navigation.PushAsync(new MainMenu());
            }
        }
        /** This function creates objects and calls their methods. First the security methods are called and if they return false call the points updating
