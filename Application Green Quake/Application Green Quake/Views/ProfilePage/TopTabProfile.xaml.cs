...
namespace Application_Green_Quake.Views.ProfilePage
{
    ...
    public partial class TopTabProfile : ContentPage
    {
        ...
        protected async override void OnAppearing()
        {
            ...
            if (progress != 0 && points - prevPoints == 10)
            {
                lvl++;
            }
            else if (progress == 0 && points - prevPoints == 10)
            {
                lvl++;
            }
            else if (progress == 2 && points - prevPoints == 8)
            {
                lvl++;
            }
            else if (progress == 4 && points - prevPoints == 6)
            {
                lvl++;
            }
            else if (progress == 6 && points - prevPoints == 4)
            {
                lvl++;
            }
            else if (progress == 8 && points - prevPoints == 2)
            {
                lvl++;
            }
            else if (progress != 0 && points - prevPoints == 20)
            {
                lvl = lvl + 2;
            }
            else if (progress == 0 && points - prevPoints == 20)
            ...
            else if (progress == 2 && points - prevPoints == 16)
            {
                lvl = lvl + 2;
            }
            else if (progress == 4 && points - prevPoints == 12)
            {
                lvl = lvl + 2;
            }
            else if (progress == 6 && points - prevPoints == 8)
            {
                lvl = lvl + 2;
            }
            else if (progress == 8 && points - prevPoints == 4)
            {
                lvl = lvl + 2;
            }
            else if (progress != 0 && points - prevPoints == 30)
            {
                lvl = lvl + 3;
            }
            else if (progress == 0 && points - prevPoints == 30)
            ...
            else if (progress == 2 && points - prevPoints == 24)
            {
                lvl = lvl + 3;
            }
            else if (progress == 4 && points - prevPoints == 18)
            {
                lvl = lvl + 3;
            }
            else if (progress == 6 && points - prevPoints == 12)
            {
                lvl = lvl + 3;
            }
            else if (progress == 8 && points - prevPoints == 6)
            {
                lvl = lvl + 3;
            }
            else if (progress != 0 && points - prevPoints == 40)
            {
                lvl = lvl + 4;
            }
            else if (progress == 0 && points - prevPoints == 40)
            ...
            else if (progress == 2 && points - prevPoints == 32)
            {
                lvl = lvl + 4;
            }
            else if (progress == 4 && points - prevPoints == 24)
            {
                lvl = lvl + 4;
            }
            else if (progress == 6 && points - prevPoints == 16)
            {
                lvl = lvl + 4;
            }
            else if (progress == 8 && points - prevPoints == 8)
            {
                lvl = lvl + 4;
            }
            else if (progress != 0 && points - prevPoints == 50)
            {
                lvl = lvl + 5;
            }
            else if (progress == 0 && points - prevPoints == 50)
            ...
            else if (progress == 4 && points - prevPoints == 30)
            {
                lvl = lvl + 5;
            }
            else if (progress == 6 && points - prevPoints == 20)
            {
                lvl = lvl + 5;
            }
            else if (progress == 8 && points - prevPoints == 10)
            {
                lvl = lvl + 5;
            }
            else if (progress != 0 && points - prevPoints == 60)
            {
                lvl = lvl + 6;
            }
            else if (progress == 0 && points - prevPoints == 60)
            ...
            else if (progress == 2 && points - prevPoints == 40)
            {
                lvl = lvl + 6;
            }
            else if (progress == 4 && points - prevPoints == 36)
            {
                lvl = lvl + 6;
            }
            else if (progress == 6 && points - prevPoints == 24)
            {
                lvl = lvl + 6;
            }
            else if (progress == 8 && points - prevPoints == 12)
            {
                lvl = lvl + 6;
            }
            else if (progress != 0 && points - prevPoints == 70)
            {
                lvl = lvl + 7;
            }
            else if (progress == 0 && points - prevPoints == 70)
            ...
            else if (progress == 2 && points - prevPoints == 56)
            {
                lvl = lvl + 7;
            }
            else if (progress == 4 && points - prevPoints == 42)
            {
                lvl = lvl + 7;
            }
            else if (progress == 6 && points - prevPoints == 28)
            {
                lvl = lvl + 7;
            }
            else if (progress == 8 && points - prevPoints == 14)
            {
                lvl = lvl + 7;
            }
            else if (progress != 0 && points - prevPoints == 80)
            {
                lvl = lvl + 8;
            }
            else if (progress == 0 && points - prevPoints == 80)
            ...
            else if (progress == 2 && points - prevPoints == 64)
            {
                lvl = lvl + 8;
            }
            else if (progress == 4 && points - prevPoints == 48)
            {
                lvl = lvl + 8;
            }
            else if (progress == 6 && points - prevPoints == 32)
            {
                lvl = lvl + 8;
            }
            else if (progress == 8 && points - prevPoints == 16)
            {
                lvl = lvl + 8;
            }
            else if (progress != 0 && points - prevPoints == 90)
            {
                lvl = lvl + 9;
            }
            else if (progress == 0 && points - prevPoints == 90)
            ...
            else if (progress == 2 && points - prevPoints == 72)
            {
                lvl = lvl + 9;
            }
            else if (progress == 4 && points - prevPoints == 54)
            {
                lvl = lvl + 9;
            }
            else if (progress == 6 && points - prevPoints == 36)
            {
                lvl = lvl + 9;
            }
            else if (progress == 8 && points - prevPoints == 18)
            {
                lvl = lvl + 9;
            }
            else if (progress != 0 && points - prevPoints == 100)
            {
                lvl = lvl + 10;
            }
            else if (progress == 0 && points - prevPoints == 100)
            ...
            else if (progress == 2 && points - prevPoints == 80)
            {
                lvl = lvl + 10;
            }
            else if (progress == 4 && points - prevPoints == 60)
            {
                lvl = lvl + 10;
            }
            else if (progress == 6 && points - prevPoints == 40)
            {
                lvl = lvl + 10;
            }
            else if (progress == 8 && points - prevPoints == 20)
            {
                lvl = lvl + 10;
            }
            else if (progress != 0 && points - prevPoints == 110)
            {
                lvl = lvl + 11;
            }
            else if (progress == 0 && points - prevPoints == 110)
            ...
            else if (progress == 2 && points - prevPoints == 88)
            {
                lvl = lvl + 11;
            }
            else if (progress == 4 && points - prevPoints == 66)
            {
                lvl = lvl + 11;
            }
            else if (progress == 6 && points - prevPoints == 44)
            {
                lvl = lvl + 11;
            }
            else if (progress == 8 && points - prevPoints == 22)
            {
                lvl = lvl + 11;
            }
            else if (progress != 0 && points - prevPoints == 120)
            {
                lvl = lvl + 12;
            }
            else if (progress == 0 && points - prevPoints == 120)
            ...
            else if (progress == 2 && points - prevPoints == 96)
            {
                lvl = lvl + 12;
            }
            else if (progress == 4 && points - prevPoints == 72)
            {
                lvl = lvl + 12;
            }
            else if (progress == 6 && points - prevPoints == 48)
            {
                lvl = lvl + 12;
            }
            else if (progress == 8 && points - prevPoints == 24)
            {
                lvl = lvl + 12;
            }
            else if (progress != 0 && points - prevPoints == 130)
            {
                lvl = lvl + 13;
            }
            else if (progress == 0 && points - prevPoints == 130)
            ...
            else if (progress == 2 && points - prevPoints == 104)
            {
                lvl = lvl + 13;
            }
            else if (progress == 4 && points - prevPoints == 78)
            {
                lvl = lvl + 13;
            }
            else if (progress == 6 && points - prevPoints == 52)
            {
                lvl = lvl + 13;
            }
            else if (progress == 8 && points - prevPoints == 26)
            {
                lvl = lvl + 13;
            }
            else if (progress != 0 && points - prevPoints == 140)
            {
                lvl = lvl + 14;
            }
            else if (progress == 0 && points - prevPoints == 140)
            ...
            else if (progress == 2 && points - prevPoints == 112)
            {
                lvl = lvl + 14;
            }
            else if (progress == 4 && points - prevPoints == 84)
            {
                lvl = lvl + 14;
            }
            else if (progress == 6 && points - prevPoints == 56)
            {
                lvl = lvl + 14;
            }
            else if (progress == 8 && points - prevPoints == 28)
            {
                lvl = lvl + 14;
            }
            else if (progress != 0 && points - prevPoints == 150)
            {
                lvl = lvl + 14;
            }
            else if (progress == 0 && points - prevPoints == 160)
            {
                lvl = lvl + 15;
            }
            else if (progress == 2 && points - prevPoints == 120)
            {
                lvl = lvl + 15;
            }
            else if (progress == 4 && points - prevPoints == 90)
            {
                lvl = lvl + 15;
            }
            else if (progress == 6 && points - prevPoints == 60)
            {
                lvl = lvl + 15;
            }
            else if (progress == 8 && points - prevPoints == 30)
            {
                lvl = lvl + 15;
            }
